module github.com/smallnest/dive-to-gosync-workshop
...
require (
	...
	github.com/kortschak/goroutine v1.0.0 // indirect
...
replace github.com/AaronJan/Hunch => github.com/aaronjan/hunch v1.1.2
